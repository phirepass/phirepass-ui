  ...
  return (
    ...
    >
        ...
        <div className="flex items-center gap-3 min-w-0 flex-1">
            ...
            <StatusIndicator isOnline={node.isOnline} size="md" />
        ...
        <StatBar label="CPU" value={node.stats.cpu} icon={<Cpu className="w-4 h-4" />} />
        <StatBar label="Memory" value={node.stats.memory} icon={<Activity className="w-4 h-4" />} />
        </div>
        ...
        <div className="flex items-center gap-3 bg-secondary/50 rounded-lg px-3 py-2.5">
            ...
            <p className="font-mono text-foreground">{node.stats.uptime}</p>
            </div>
        </div>
        <div className="flex items-center gap-3 bg-secondary/50 rounded-lg px-3 py-2.5">
            ...
            <p className="font-mono text-foreground">{node.stats.ping}ms</p>
            </div>
        </div>
        <div className="flex items-center gap-3 bg-secondary/50 rounded-lg px-3 py-2.5">
            ...
            <p className="font-mono text-foreground">{node.stats.loadAvg[0].toFixed(2)}</p>
            </div>
        </div>
        <div className="flex items-center gap-3 bg-secondary/50 rounded-lg px-3 py-2.5">
            ...
            <p className="font-mono text-foreground">{node.stats.openConnections}</p>
            </div>
        </div>
        </div>
        ...
        <span>{node.stats.processes} processes running</span>
        <span className="text-muted-foreground/60">Last seen: {node.lastSeen}</span>
        </div>
