        ...
        <div className="space-y-6">
            ...
            <div className="space-y-2">
                ...
                <input
                    ...
                    placeholder="••••••••"
                    className={`w-full bg-secondary/50 border rounded-xl px-4 py-3.5 pr-12 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all ${
