...
export default function Signup() {
    ...
    const handleSignup = async (e: React.FormEvent) => {
        e.preventDefault();
        // Form signup is disabled - only OAuth signup is available
    };
    ...
    const isGithubSignupDisabled = isLoading || isConfigLoading || !config.NEXT_PUBLIC_GITHUB_CLIENT_ID;
                ...
                <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12">
                    <div className="w-full max-w-md animate-fade-in">
                        ...
                        <div className="mb-8 hidden lg:block">
                            ...
                            <p className="text-muted-foreground">Get started with secure access and monitoring</p>
                        </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <Button
                                    ...
                                    disabled={true}
                                    title="Google signup not available - use GitHub"
                                >
                                ...
                                <Button
                                    ...
                                    disabled={isGithubSignupDisabled}
                                    title={isConfigLoading ? 'Loading app configuration...' : (!config.NEXT_PUBLIC_GITHUB_CLIENT_ID ? 'GitHub signup is not configured' : undefined)}
                                >
                            ...
                            {/* Email Form */}
                            <form onSubmit={handleSignup} className="space-y-4 opacity-50 pointer-events-none">
                                ...
                                <Button
                                    ...
                                    disabled={true}
                                    title="Form signup disabled - use GitHub"
                                >
                                    Create account
                                </Button>
                            </form>
